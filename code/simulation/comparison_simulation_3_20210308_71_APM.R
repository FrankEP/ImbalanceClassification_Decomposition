...
print("3")
source(paste0(path,'/code/aaaa_GA_Rpackage_OptimalClassifiers_20201013_simplified_optimizeCombines_RFE_Pruning20210313_1_MultiOutbag.R'))
...
pathname <-  "simulation_3_20210320_71_APM"
...
### simulation_2_20210305_71
# N_matrix <- rbind(c(100, 100, 100, 100, 200, 300),
#                   c(100, 100, 100, 100, 300, 500),
#                   c(100, 100, 100, 100, 500, 700),
#                   c(100, 100, 100, 100, 700, 1100))

### simulation_2_20210306_71
# N_matrix <- rbind(c(20, 20, 20, 20, 40, 60),
#                   c(20, 20, 20, 20, 60, 100),
#                   c(20, 20, 20, 20, 100, 140),
#                   c(20, 20, 20, 20, 140, 220),
#                   c(30, 30, 30, 30, 60, 90),
#                   c(30, 30, 30, 30, 90, 150),
#                   c(30, 30, 30, 30, 150, 210),
#                   c(30, 30, 30, 30, 210, 330))

### simulation_3_20210307_71
N_matrix <- rbind(c(20, 20, 20, 20, 40, 60),
                  c(20, 20, 20, 20, 60, 100),
                  c(20, 20, 20, 20, 100, 140),
                  c(20, 20, 20, 20, 140, 220),
                  ...
                  c(30, 30, 30, 30, 150, 210),
                  c(30, 30, 30, 30, 210, 330),
                  c(50, 50, 50, 50, 100, 150),
                  c(50, 50, 50, 50, 150, 210),
                  c(50, 50, 50, 50, 250, 350),
                  c(50, 50, 50, 50, 350, 550))
...
for(rep_i in 1:num_rep){
  ...
  for(fold_i in 1:num_Kfold){
    ...
    if(is.element("ATM", names_methods)){
      results_ATM <- Adaptive_threshold_moving(X=data_train_x, Y=data_train_y, NEW_X=data_test_x, num_bootstrap=3, pathname = pathname, fold_i=N_matrix_i, rep_i=rep_i, 
