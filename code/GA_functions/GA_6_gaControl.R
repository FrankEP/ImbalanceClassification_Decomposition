...
.ga.default <- list("binary" = list(population = "gabin_Population_R",
                                    selection  = "gabin_lrSelection_R",
                                    crossover  = "gabin_spCrossover_R",
                                    mutation   = "gabin_raMutation_R"),
                    "real-valued" = list(population = "gareal_Population_R",
                                         selection  = "gareal_lsSelection_R",
                                         crossover  = "gareal_laCrossover_R",
                                         mutation   = "gareal_raMutation_R"),                                    
                    "permutation" = list(population = "gaperm_Population_R",
                                         selection  = "gaperm_lrSelection_R",
                                         crossover  = "gaperm_oxCrossover_R",
                                         mutation   = "gaperm_simMutation_R"),
