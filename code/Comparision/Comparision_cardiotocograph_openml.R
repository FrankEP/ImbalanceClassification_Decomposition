...
pathname <-  "cardiotocography_openml"

data_all <- openxlsx::read.xlsx(paste0(path,"/data_open/", pathname,"/cardiotocography_openml.xlsx"))

name_y_data_all <- "Class"
names_x_data_all <- colnames(data_all)[c(1:35)]
