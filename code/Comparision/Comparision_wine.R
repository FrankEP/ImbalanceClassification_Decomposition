...
print("2")
# source(paste0(path,'/code/1_function_?????�?Multi-Imbalance Matlab????).R'))
print("3")
source(paste0(path,'/code/aaaa_GA_Rpackage_OptimalClassifiers_20200923.R'))
...
data_all <- openxlsx::read.xlsx(paste0(path,"/data_open/", pathname,"/wine.xlsx"))

name_y_data_all <- "CLASS"
names_x_data_all <- colnames(data_all)[c(2:14)]
