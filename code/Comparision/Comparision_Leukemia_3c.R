...
pathname <-  "Leukemia_3c"

data_all <- openxlsx::read.xlsx(paste0(path,"/data_open/", pathname,"/Leukemia_3c.xlsx"), colNames = FALSE)
...
data_all[, name_y_data_all] <- ifelse(data_all[, name_y_data_all]=="AML", 1, 
                                      ifelse(data_all[, name_y_data_all]=="B-cell", 2, 3))
