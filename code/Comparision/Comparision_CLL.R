...
data_all_y <- openxlsx::read.xlsx(paste0(path,"/data_open/", pathname,"/CLL_Y.xlsx"), colNames = FALSE)
data_all_x <- read.csv(paste0(path,"/data_open/", pathname,"/CLL_X.csv"), header = FALSE)
